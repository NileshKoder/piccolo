...
class AddLineToLoadingEnumInLocations extends Migration
{
    ...
    public function up()
    {
        Schema::table('loading_enum_in_locations', function (Blueprint $table) {
            DB::statement("ALTER TABLE `locations` CHANGE `type` `type` ENUM('GLASS','CERAMIC','RECYCLE','LINES','CURING','LOADING','LINE_TO_WH','LINE_TO_LOADING') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL;");
        });
    }
