...
Route::get("orders/{order}/order-item/{order_item}/manual-mapping", [OrderController::class, 'manualMapping'])->name('order.orderItem.manual-mapping');
Route::post("orders/{order}/order-item/{order_item}/manual-mapping", [OrderController::class, 'storeManualMapping'])->name('order.orderItem.store-manual-mapping');
