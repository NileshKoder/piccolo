...
!(function (t) {
            ...
            c = (function (t) {
                ...
                return (
                    ...
                    (e.prototype.encode = function () {
                        ...
                        return { text: this.text == this.data ? this.text.replace(/[^\x20-\x7E]/g, "") : this.text, data: this.getEncoding(n) + t.result + this.getEncoding((t.checksum + n) % 103) + this.getEncoding(106) };
                    }),
                    ...
                    (e.prototype.nextA = function (t, e) {
                        ...
                        if (t[0] >= 200)
                            (r = t[0] - 105),
                                t.shift(),
                                99 === r ? (n = this.nextC(t, e + 1)) : 100 === r ? (n = this.nextB(t, e + 1)) : 98 === r ? ((t[0] = t[0] > 95 ? t[0] - 96 : t[0]), (n = this.nextA(t, e + 1))) : (n = this.nextA(t, e + 1));
                        else {
                            var o = t[0];
                    ...
                    (e.prototype.nextB = function (t, e) {
                        ...
                        t[0] >= 200
                            ? ((r = t[0] - 105),
                              t.shift(),
                              99 === r ? (n = this.nextC(t, e + 1)) : 101 === r ? (n = this.nextA(t, e + 1)) : 98 === r ? ((t[0] = t[0] < 32 ? t[0] + 96 : t[0]), (n = this.nextB(t, e + 1))) : (n = this.nextB(t, e + 1)))
                    ...
                    (e.prototype.nextC = function (t, e) {
                        ...
                        var n, r;
                        t[0] >= 200
                            ? ((r = t[0] - 105), t.shift(), (n = 100 === r ? this.nextB(t, e + 1) : 101 === r ? this.nextA(t, e + 1) : this.nextC(t, e + 1)))
                            : ((r = 10 * (t[0] - 48) + t[1] - 48), t.shift(), t.shift(), (n = this.nextC(t, e + 1)));
                        var o = this.getEncoding(r),
                            i = r * e;
                        return { result: o + n.result, checksum: i + n.checksum };
                    }),
    ...
    function (t, e, n) {
        ...
        function o(t) {
            ...
            if ("undefined" != typeof SVGElement && t instanceof SVGElement) return { element: t, options: (0, c["default"])(t), renderer: l["default"].SVGRenderer };
            if ("undefined" != typeof HTMLCanvasElement && t instanceof HTMLCanvasElement) return { element: t, options: (0, c["default"])(t), renderer: l["default"].CanvasRenderer };
            if (t && t.getContext) return { element: t, renderer: l["default"].CanvasRenderer };
            if (t && "object" === ("undefined" == typeof t ? "undefined" : u(t)) && !t.nodeName) return { element: t, renderer: l["default"].ObjectRenderer };
    ...
    function (t, e, n) {
        ...
        function u(t) {
            ...
            return (
                (e = o >= 2 ? String.fromCharCode(210) + f(t) : n > r ? String.fromCharCode(208) + s(t) : String.fromCharCode(209) + c(t)),
            ...
            p = (function (t) {
                ...
                return (
                    ...
                    (e.prototype.guardedEncoding = function () {
                        ...
                        return (
                            this.options.displayValue && e.push({ data: "000000000000", text: this.text.substr(0, 1), options: { textAlign: "left", fontSize: this.fontSize } }),
                            e.push({ data: "101", options: { height: this.guardHeight } }),
                            e.push({ data: t.encode(r, n), text: this.text.substr(1, 6), options: { fontSize: this.fontSize } }),
                            e.push({ data: "01010", options: { height: this.guardHeight } }),
                            e.push({ data: t.encode(o, "RRRRRR"), text: this.text.substr(7, 6), options: { fontSize: this.fontSize } }),
                            e.push({ data: "101", options: { height: this.guardHeight } }),
                            this.options.lastChar && this.options.displayValue && (e.push({ data: "00" }), e.push({ data: "00000", text: this.options.lastChar, options: { fontSize: this.fontSize } })),
                            e
                        );
                    }),
                    (e.prototype.flatEncoding = function () {
                        var t = new c["default"](),
                            e = "",
                            n = this.getStructure()[this.data[0]];
                        return (e += "101"), (e += t.encode(this.data.substr(1, 6), n)), (e += "01010"), (e += t.encode(this.data.substr(7, 6), "RRRRRR")), (e += "101"), { data: e, text: this.text };
                    }),
                    e
                );
            })(l["default"]);
            ...
            p = (function (t) {
                ...
                return (
                    ...
                    (e.prototype.encode = function () {
                        ...
                        return (e += t.startBin), (e += t.encode(n, "LLLL")), (e += t.middleBin), (e += t.encode(r, "RRRR")), (e += t.endBin), { data: e, text: this.text };
                    }),
                    e
                );
            })(l["default"]);
            ...
            p = (function (t) {
                ...
                return (
                    ...
                    (e.prototype.flatEncoding = function () {
                        var t = new c["default"](),
                            e = "";
                        return (e += "101"), (e += t.encode(this.data.substr(0, 6), "LLLLLL")), (e += "01010"), (e += t.encode(this.data.substr(6, 6), "RRRRRR")), (e += "101"), { data: e, text: this.text };
                    }),
                    (e.prototype.guardedEncoding = function () {
                        var t = new c["default"](),
                            e = [];
                        return (
                            this.displayValue && e.push({ data: "00000000", text: this.text.substr(0, 1), options: { textAlign: "left", fontSize: this.fontSize } }),
                            e.push({ data: "101" + t.encode(this.data[0], "L"), options: { height: this.guardHeight } }),
                            e.push({ data: t.encode(this.data.substr(1, 5), "LLLLL"), text: this.text.substr(1, 5), options: { fontSize: this.fontSize } }),
                            e.push({ data: "01010", options: { height: this.guardHeight } }),
                            e.push({ data: t.encode(this.data.substr(6, 5), "RRRRR"), text: this.text.substr(6, 5), options: { fontSize: this.fontSize } }),
                            e.push({ data: t.encode(this.data[11], "R") + "101", options: { height: this.guardHeight } }),
                            this.displayValue && e.push({ data: "00000000", text: this.text.substr(11, 1), options: { textAlign: "right", fontSize: this.fontSize } }),
                            e
                        );
                    }),
                    e
        ...
        var u = n(0),
            ...
            c = (function (t) {
                function e(n, r) {
                    o(this, e);
                    var a = i(this, t.call(this, n, r));
                    return (a.binaryRepresentation = { 0: "00110", 1: "10001", 2: "01001", 3: "11000", 4: "00101", 5: "10100", 6: "01100", 7: "00011", 8: "10010", 9: "01010" }), a;
                }
                return (
                    a(e, t),
                    (e.prototype.valid = function () {
        ...
        function o(t) {
            ...
            for (var n in s["default"])
                s["default"].hasOwnProperty(n) &&
                    (t.hasAttribute("jsbarcode-" + n.toLowerCase()) && (e[n] = t.getAttribute("jsbarcode-" + n.toLowerCase())), t.hasAttribute("data-" + n.toLowerCase()) && (e[n] = t.getAttribute("data-" + n.toLowerCase())));
            ...
            s = (function () {
                ...
                return (
                    ...
                    (t.prototype.drawCanvasText = function (t, e) {
                        ...
                        if (t.displayValue) {
                            var o, i;
                            (i = "top" == t.textPosition ? t.marginTop + t.fontSize - t.textMargin : t.height + t.textMargin + t.marginTop + t.fontSize),
                                (n.font = r),
                                "left" == t.textAlign || e.barcodePadding > 0 ? ((o = 0), (n.textAlign = "left")) : "right" == t.textAlign ? ((o = e.width - 1), (n.textAlign = "right")) : ((o = e.width / 2), (n.textAlign = "center")),
    ...
    function (t, e, n) {
        ...
        var s = n(10),
            ...
            j = function (t, e, n) {
                ...
                return (
                    (r._renderProperties = (0, g["default"])(t)),
                    (r._encodings = []),
                    (r._options = C["default"]),
                    (r._errorHandler = new x["default"](r)),
                    "undefined" != typeof e && ((n = n || {}), n.format || (n.format = a()), r.options(n)[n.format](e, n).render()),
                    r
                );
            };
        ...
        (E.prototype.options = function (t) {
            ...
            (E.prototype.render = function () {
                ...
                if (Array.isArray(this._renderProperties)) for (var t = 0; t < this._renderProperties.length; t++) u(this._renderProperties[t], this._encodings, this._options);
                else u(this._renderProperties, this._encodings, this._options);
                return this;
            }),
            (E.prototype._defaults = C["default"]),
            "undefined" != typeof window && (window.JsBarcode = j),
